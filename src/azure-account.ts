...
import { azureCustomCloud, clientId, cloudSetting, commonTenantId, customCloudArmUrlSetting, environmentLabels, prefix, resourceFilterSetting, staticEnvironmentNames, tenantSetting } from './constants';
